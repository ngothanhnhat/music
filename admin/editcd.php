...
<form action="" method="POST"  class="form-horizontal" role="form">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control"  name = "tenchude" id="tenchude" placeholder=""required="required"value="<?php echo $r->TenChuDe;?>">
    </div>
  ...
  <div class="form-group">
    <div class="col-sm-offset-7 col-sm-5">
      <button type="submit" class="btn btn-default" name="suacd" >Sửa </button>
    </div>
  </div>   
